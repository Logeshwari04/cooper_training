class rent:
    def houses():
        ...
        if area == "1":
            data = ["Locality:kodambakkam", "area:chennai", "square_feet:798", "Type:2BHK", "Rent:Rs.6000/mon", "owner_id=1"]
            for i in data:
                print(i)
        elif area == "2":
            data = ["Locality:Anna nagar", "area:chennai" "square_feet:1200", "Type:3BHK", "Rent:Rs.15000/mon", "owner_id=2"]
            for i in data:
                print(i)
        elif area == "3":
            data = ["Locality:Goripalayam", "area:madurai" "square_feet:560", "Type:1BHK", "Rent:Rs.5500/mon", "owner_id=1"]
            for i in data:
                print(i)
